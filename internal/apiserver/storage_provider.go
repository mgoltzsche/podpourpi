...
//
// Copied from https://github.com/kubernetes-sigs/apiserver-runtime/blob/v1.0.2/pkg/builder/storage_provider.go
//
...
type subResourceStorageProvider struct {
	...
	parentStorageProvider      StorageProvider
	subResourceStorageProvider StorageProvider
}
